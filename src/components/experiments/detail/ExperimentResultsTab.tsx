...
import { AlertTriangle, CheckCircle2, LightbulbIcon, Compass } from 'lucide-react';
    ...
    <div className="space-y-6">
      <Card className="p-6">
        ...
        {experiment.results ? (
          ...
          <div className="flex items-center text-amber-600 bg-amber-50 p-4 rounded-md">
            ...
            <p>No results have been recorded for this experiment yet.</p>
          </div>
        )}
      </Card>
      ...
      <Card className="p-6">
        ...
        {experiment.insights ? (
          ...
          <div className="flex items-center text-amber-600 bg-amber-50 p-4 rounded-md">
            <AlertTriangle className="h-5 w-5 mr-2" />
            <p>No insights have been recorded for this experiment yet.</p>
          </div>
        )}
      </Card>
      ...
      <Card className="p-6">
        ...
        {experiment.decisions ? (
          ...
          <div className="flex items-center text-amber-600 bg-amber-50 p-4 rounded-md">
            <AlertTriangle className="h-5 w-5 mr-2" />
            <p>No decisions or next steps have been recorded for this experiment yet.</p>
          </div>
        )}
      </Card>
    </div>
