...
import { GrowthMetric, GrowthExperiment, GrowthChannel } from '@/types/database';
...
const ScalingReadinessChecklist: React.FC<ScalingReadinessChecklistProps> = ({
  ...
  }, [projectId, growthMetrics, growthExperiments, growthChannels]);
  ...
  const generateChecklist = async () => {
    try {
      ...
      // 1. Validated Unit Economics - LTV:CAC Ratio
      ...
      // 2. Acquisition Channels - At least 3 validated channels
      ...
      // 3. Retention Metrics - 30% Retention in 60 days
      ...
      // 4. Repeatable Growth Model - 2 Validated Growth Experiments
