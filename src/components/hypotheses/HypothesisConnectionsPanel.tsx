  ...
  return <Card>
      ...
      <CardContent>
        <Tabs defaultValue="experiments" className="w-full">
          ...
          <TabsContent value="experiments" className="pt-4 py-0">
            {linkedExperiments.length > 0 ? <div className="space-y-4">
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-sm font-medium text-blue-700">Linked Experiments</h3>
                  <Button size="sm" variant="outline" onClick={handleCreateExperiment}>
                ...
                <div className="space-y-3">
                  {linkedExperiments.map(experiment => <div key={experiment.id} className="p-3 border rounded-md hover:bg-gray-50 cursor-pointer" onClick={() => navigateToExperiment(experiment.id)}>
